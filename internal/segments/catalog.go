...
var catalog = []Meta{
	...
	{Name: "context", Description: "Context-window usage gauge (tokens + %)", DefaultOn: true, Role: "gauge"},
	{Name: "cost", Description: "Session cost (with $/hr burn rate and daily/weekly/monthly rollups)", DefaultOn: true, Role: "metric"},
	...
	{Name: "rate_limits", Description: "5-hour and 7-day usage limits with reset countdown and 5h block cost", ProMaxOnly: true, Role: "gauge"},
