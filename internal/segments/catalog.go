...
var catalog = []Meta{
	...
	{Name: "cost", Description: "Session cost in USD (with $/hr burn rate)", DefaultOn: true, Role: "metric"},
	...
	{Name: "rate_limits", Description: "5-hour and 7-day usage limits with reset countdown", ProMaxOnly: true, Role: "gauge"},
